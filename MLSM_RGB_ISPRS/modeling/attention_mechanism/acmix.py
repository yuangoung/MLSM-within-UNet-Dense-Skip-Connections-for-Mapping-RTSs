...
class ACmix(nn.Module):
    def __init__(self, in_planes=320, out_planes=128, kernel_att=7, head=8, kernel_conv=3, stride=1, dilation=1):
...
if __name__ == '__main__':
    input=torch.randn(50,320,7,7)
    acmix = ACmix(in_planes=320)
    output=acmix(input)
    print(output.shape)
